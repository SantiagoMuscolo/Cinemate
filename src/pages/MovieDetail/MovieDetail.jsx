...
export const MovieDetail = ({title}) => {
    ...
    useEffect(() => {
        async function fetchMovie() {
            const response = await fetch(`https://api.themoviedb.org/3/movie/${params.id}?api_key=4c777fd647114fc03b6bdb29458549ac`)
        ...
        <main>
            <section className="flex justify-around flex-wrap py-5">
                ...
                <div className="max-w-xl text-gray-700 text-lg dark:text-white">
                    ...
                    {movie.genres ? (
                        <p className="my-7 flex  flex-wrap gap-2">{movie.genres.map((genre) => (
